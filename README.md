...
shardAmount: 100,
    ...
    prefix:['$getservervar[prefix]','$getglobaluservar[up]'], //change the prefix in variabals.js do control+f and type prefix in the menu then change it also change up
   mobile: false,
suppressAll: true,
errorMessage: "Oh no! error i don't know what hepened",
fetchInvites: true,
